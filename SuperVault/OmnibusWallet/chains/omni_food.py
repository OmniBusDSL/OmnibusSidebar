"""
OmnibusWallet -- chains/omni_food.py
OmniBus chain: omnibus.food domain
Algorithm: Falcon-512 — Compact Signatures, 192-bit
Coin type: 779
Path: m/44'/779'/0'/0/index
...
CHAIN_ID      = "OMNI_FOOD"
CHAIN_NAME    = "OmniBus · omnibus.food"
COIN_SYMBOL   = "OMB"
COIN_TYPE     = 779
DOMAIN        = "omnibus.food"
PREFIX        = "ob_f5_"
